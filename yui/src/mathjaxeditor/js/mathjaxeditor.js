...
/*
    var undo=Y.Node.create('<button type="button" class="'
           ...
           + M.util.image_url('undo', 'editor_local') + '" title="'+M.util.get_string('undo','local_mathslate')+'"/></button>');
    var redo=Y.Node.create('<button type="button" class="'
           ...
           + M.util.image_url('redo', 'editor_local') + '" title="'+M.util.get_string('redo','local_mathslate')+'"/></button>');
    var clear=Y.Node.create('<button type="button" class="'
           ...
           + M.util.image_url('delete', 'editor_local') + '" title="'+M.util.get_string('clear','local_mathslate')+'"/></button>');
    var help=Y.Node.create('<button type="button" class="'
           ...
           + M.util.image_url('help', 'core') + '" title="'+M.util.get_string('help','local_mathslate')+'"/></button>');
*/

    var undo=Y.Node.create('<button type="button" class="' + CSS.UNDO+'"'
           + '" title="'+M.util.get_string('undo','local_mathslate')+'"/>'
           +'<math><mo>&#x25C1;</mo></math>'
           +'</button>');

    var redo=Y.Node.create('<button type="button" class="' + CSS.REDO+'"'
           + '" title="'+M.util.get_string('redo','local_mathslate')+'"/>'
           +'<math><mo>&#x25B7;</mo></math>'
           +'</button>');
    var clear=Y.Node.create('<button type="button" class="' + CSS.CLEAR+'"'
           + '" title="'+M.util.get_string('clear','local_mathslate')+'"/>'
           +'<math><mi>&#x2718;</mi></math>'
           +'</button>');

    var help=Y.Node.create('<button type="button" class="'
           +CSS.HELP+'" title="'
           + M.util.get_string('help','local_mathslate')+'">'
           +'<math><mi>&#xE47C;</mi></math>'
           + '</button>');
    ...
    help.on('click', function(){
        preview.setHTML('<iframe src="'+M.local_mathslate.help+'" style="width: '
